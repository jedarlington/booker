...
export default function AuthenticatedLayout({ header, children }) {
    ...
    return (
        <div className="min-h-screen bg-gray-100 dark:bg-gray-900">
            ...
            {flash && flash.success && (
                <div className="px-4 py-2 mx-auto mb-4 text-sm text-green-700 bg-green-100 border border-green-400 rounded max-w-7xl sm:px-6 lg:px-8">
                    {flash.success}
                </div>
            )}
            {flash && flash.error && (
                <div className="px-4 py-2 mx-auto mb-4 text-sm text-red-700 bg-red-100 border border-red-400 rounded max-w-7xl sm:px-6 lg:px-8">
                    {flash.error}
                </div>
            )}
